...
const Form = () => {
	// States to save input values for future use!
	...
	const [empty, setEmpty] = useState(
		"border-fmSanJuanBlue placeholder:text-fmSanJuanBlue"
	);
	...
	return (
		<main className="">
			<form
				className="flex flex-col md:items-center gap-[24px]"
			...
			>
				<div>
					...
					/>
					<p className="text-[11px] text-red-600 mt-[4px] mb-[-6px] mr-auto ml-4">
						{nameErr}
					</p>
				</div>
				<div>
